  ...
  <div class="wrap">
    ...
    <div class="solution-preview">
      @foreach([
        ...
        ['num'=>'04','icon'=>'🛡️','title_sw'=>'Kagua Pembejeo','title_en'=>'Input Verification','desc_sw'=>'Hakikisha pembejeo ni za kweli kupitia TFRA/TPHPA na jamii.','desc_en'=>'Verify input authenticity via TFRA/TPHPA registry and community reports.'],
...
const mkPageTranslations = {
  sw: {
    ...
    sol3_title:'Kagua Pembejeo', sol3_desc:'Hakikisha pembejeo ni za kweli kupitia TFRA/TPHPA na jamii.',
  ...
  en: {
    ...
    sol3_title:'Input Verification', sol3_desc:'Verify input authenticity via TFRA/TPHPA registry and community reports.',
