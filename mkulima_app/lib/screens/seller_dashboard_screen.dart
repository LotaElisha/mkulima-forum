          ...
          children: [
            ...
            Card(
              child: Column(
                children: [
                  ListTile(
                    leading: const Icon(Icons.add_box, color: Color(0xFF2E7D32)),
                  ...
                  ListTile(
                    leading: const Icon(Icons.list, color: Color(0xFF2E7D32)),
                    title: const Text('Angalia Bidhaa Zangu'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () {},
                  ),
                  const Divider(height: 1),
                  ...
                  ListTile(
                    ...
                    title: const Text('Ripoti za Mauzo'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () {},
                  ),
                ],
